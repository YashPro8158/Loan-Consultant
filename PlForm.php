...
<body>
                ...
                <div class="main-menu f-right d-none d-lg-block">
                  <nav>
                    <ul id="navigation">
                      ...
                      <li><a href="Credit_product.html">About</a></li>
                      <li>
                      ...
                      <!--                       <li>
                        <a href="EmiCalculator.html">Calculate Emi</a>
                      </li> -->
  ...
  <main>
    <div id="personalLoan-form">
      <form action="#" method="post">
        ...
        <div id="btn-proceed"><button type="submit"> Proceed </button></div>
      </form>
    </div>
  ...
  <script src="//code.tidio.co/i47b8yxq75icckp4bqaat6cwisk0iykk.js" async></script>
</body>
